...
";
    ...
    /// 
    /// evenshtein Distance可以用来比较两个字符串的相似度，即两个字符串之间的“距离”。
    ...
    public class Levenshtein
    {
        ...
        public int iLD(String sRow, String sCol)
        {
            ...
            /// Test string length
            if (System.Math.Max(sRow.Length, sCol.Length) > System.Math.Pow(2, 31))
                throw (new Exception("\nMaximum string length in Levenshtein.iLD is " + System.Math.Pow(2, 31) + ".\nYours is " + System.Math.Max(sRow.Length, sCol.Length) + "."));
        ...
        public int LD(String sNew, String sOld)
        {
            ...
            /// Test string length
            if (System.Math.Max(sNew.Length, sOld.Length) > System.Math.Pow(2, 31))
                throw (new Exception("\nMaximum string length in Levenshtein.LD is " + System.Math.Pow(2, 31) + ".\nYours is " + System.Math.Max(sNew.Length, sOld.Length) + "."));
