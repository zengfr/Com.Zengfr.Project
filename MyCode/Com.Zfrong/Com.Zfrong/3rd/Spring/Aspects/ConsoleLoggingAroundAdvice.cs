...
namespace Com.Zfrong.Common.Spring.Aspects
{
	...
	public class ConsoleLoggingAroundAdvice : IMethodInterceptor
	{
        ...
        {
            Console.Out.WriteLine("Around".PadRight(80, '-'));
            Console.Out.WriteLine(String.Format("Method:{0}", invocation.Method.Name));

			object returnValue = invocation.Proceed();

			Console.Out.WriteLine(String.Format("RTN:{0}", returnValue));
