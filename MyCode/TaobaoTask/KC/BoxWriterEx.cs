...
{
    public class BoxWriterEx : IBoxWriter
    {
        ...
        public BoxWriterEx(IBoxStyle lines, int width, int captionWidth, int padding)
        {
            _lines = lines;
        ...
        public string Footer
        {
            get
            {
                var footer = string.Format("{0}{1}{2}{3}", _padding, _lines.BL, new string(_lines.T, _insideWidth), _lines.BR);
                return footer;
            }
        }
        ...
        public string Line
        {
            get
            {
                var line = string.Format("{0}{1}{2}{3}", _padding, _lines.LJ, new string(_lines.T, _insideWidth), _lines.RJ);
                return line;
            }
        }
