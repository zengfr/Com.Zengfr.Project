...
//引用十分简单:
//ConsoleUtil.DisableCloseButton(Console.Title);//禁止控制台关闭按钮.
//ConsoleUtil.RegisterCloseConsoleHandle();//注册控制台关闭事件,注意,只有执行该该操作,事件ClosedConsole才会引发.
//ConsoleUtil.ClosedConsole+=(sender,e)=>Console.WriteLine("控制台关闭");
}
