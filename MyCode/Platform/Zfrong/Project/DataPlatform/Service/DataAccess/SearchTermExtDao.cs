...
{
    public interface ISearchTermExtDao : IExtDao<SearchTerm>
    {

    }
    public class SearchTermExtDao : ExtDaoBase<SearchTerm>, ISearchTermExtDao
    {
        public virtual ISessionFactory SessionFactory { get; set; }
        public SearchTermExtDao(IExtDaoPlugin<SearchTerm> plugin)
            : base(plugin)
        {
