...
{
    public interface IStatisticsExtDao : IExtDao<Statistics>
    {

    }
    public class StatisticsExtDao : ExtDaoBase<Statistics>, IStatisticsExtDao
    {
        public virtual ISessionFactory SessionFactory { get; set; }
        public StatisticsExtDao(IExtDaoPlugin<Statistics> plugin)
            : base(plugin)
        {
