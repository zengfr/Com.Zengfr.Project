...
{
    public class SearchTermController : ExtServiceControllerBase<SearchTerm>
    {
        public SearchTermController(string endpointConfigurationName)
         {
             this.ServicePlugin = MyChannelFactory.CreateChannelService<ISearchTermExtService>(string.Format("{0}", endpointConfigurationName));
         }
