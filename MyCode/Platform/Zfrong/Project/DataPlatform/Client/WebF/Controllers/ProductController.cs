...
{
    public class ProductController : ExtServiceControllerBase<Product>
    {
        public ProductController(string endpointConfigurationName)
         {
             this.ServicePlugin = MyChannelFactory.CreateChannelService<IProductExtService>(string.Format("{0}", endpointConfigurationName));
         }
