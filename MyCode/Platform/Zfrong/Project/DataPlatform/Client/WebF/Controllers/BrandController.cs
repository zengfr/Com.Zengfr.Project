...
{
    public class BrandController : ExtServiceControllerBase<Brand>
    {
        public BrandController(string endpointConfigurationName)
         {
             this.ServicePlugin = MyChannelFactory.CreateChannelService<IBrandExtService>(string.Format("{0}", endpointConfigurationName));
         }
