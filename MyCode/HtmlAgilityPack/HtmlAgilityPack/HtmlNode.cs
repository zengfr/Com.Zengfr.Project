	...
	public class HtmlNode: IXPathNavigable
	{
		...
		public virtual string OuterHtml
		{
			get
			{
                ...
                if(_outerlength<=0)//zfr
                    return string.Empty;//zFr
        ...
        public virtual float Score
        {
            get
            {
                ...
                return this.Depth * (this.Depth - 1) * (this.InnerText.Length - len);
               // return this.Depth * (this.Depth - 1) * (this.InnerText.Length - len);// / this.OwnerDocument.Text.Length;
                //return  this.InnerText.Length / (this.OuterHtml.Length - this.InnerText.Length);//

                //return this.Depth * this.Depth * this.InnerText.Length;
                //return this.Depth * this.Depth * this.InnerText.Length / this.OuterHtml.Length;//
                //return this.Depth * this.Depth * this.InnerText.Length/this.OwnerDocument.Text.Length;
                //return this.Depth  * this.InnerText.Length % this.OuterHtml.Length;//
                // return this.Depth * (this.Depth) * this.InnerText.Length / (this.OuterHtml.Length - this.InnerText.Length);
            }
        }
        private  int depth = 1;
         /// <summary>
